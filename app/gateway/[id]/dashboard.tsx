...
export default function GatewayDashboard() {
  ...
  // En vez de graficar cada request individual (ruidoso: varios requests
  // pueden caer en el mismo minuto durante pruebas, generando ejes X
  // amontonados), se agrupan en baldes fijos.
  // Se usan baldes de 3hs (8 puntos en 24hs) en vez de 1hs (24 puntos)
  // a propósito: con 24 puntos en un ancho fijo sin scroll, cada etiqueta
  // queda con ~11px de espacio real y se corta ("0...") sin importar el
  // estilo de texto que se le ponga. Con 8 puntos cada etiqueta tiene
  // ~35-40px, suficiente para mostrarse completa en cualquier resolución.
  // Conteos (recibidas/insertadas/duplicadas) se SUMAN por balde;
  // tiempos (demora/procesamiento) se PROMEDIAN entre los requests del balde.
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* 2. HISTORIAL DE INGESTA (últimas 24hs, vía Supabase — no requiere BLE) */}
        ...
        {hasIngestData && (
          <>
            ...
            {/* Demora y Procesamiento como stats simples, no como gráfico:
                varían poco y un promedio de 24hs dice más de un vistazo
                que dos curvas casi planas ocupando toda la pantalla. */}
            <Text style={styles.sectionHeader}>
